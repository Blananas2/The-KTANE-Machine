...
I’ve given all modules a 3-letter prefix so one module’s code doesn’t affect another, thus, making a solver for multiple modules is possible if desired. These module codes can be found in the file `1.1-Module_Codes.md`
.
